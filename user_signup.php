		...
		<form action="user_signed_up.php" method="post">
			<table>
				...
				<tr>
					...
					<td><input class="input" type="tel" pattern="[1-9]{1}[0-9]{9}" name="phone" placeholder="Enter Number with 10 digits" required></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td><input class="input" type="date" name="dob" value="01-01-2000" max="2002-12-31"required></td>
				</tr>
				<tr><td><br></td></tr>
				<tr>
